...
Vagrant.configure(2) do |config|
  ...
  config.vm.provider "virtualbox" do |vb|
    ...
    vb.customize ["createhd",  "--filename", "machine1_disk2", "--size", "4096"]
    vb.customize ["createhd",  "--filename", "machine1_disk3", "--size", "4096"]
    ...
    vb.customize ["storageattach", :id, "--storagectl", "SATA Controller", "--port", "3", "--type", "hdd", "--medium", "machine1_disk2.vdi"]
    vb.customize ["storageattach", :id, "--storagectl", "SATA Controller", "--port", "4", "--type", "hdd", "--medium", "machine1_disk3.vdi"]
  end
